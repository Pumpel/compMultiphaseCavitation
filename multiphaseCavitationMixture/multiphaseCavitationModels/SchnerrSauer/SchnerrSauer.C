...
namespace Foam
{
namespace MultiphaseCavitationModels
{
...
Foam::MultiphaseCavitationModels::SchnerrSauer::SchnerrSauer
(
...
Foam::MultiphaseCavitationModels::SchnerrSauer::rRb
(
...
Foam::MultiphaseCavitationModels::SchnerrSauer::alphaNuc() const
{
...
Foam::tmp<Foam::volScalarField>
Foam::MultiphaseCavitationModels::SchnerrSauer::pCoeff
(
...
Foam::MultiphaseCavitationModels::SchnerrSauer::mDotAlphaW() const
{
...
Foam::Pair<Foam::tmp<Foam::volScalarField>>
Foam::MultiphaseCavitationModels::SchnerrSauer::mDotP() const
{
    const volScalarField& p = alpha1_.db().lookupObject<volScalarField>("p");
    volScalarField pCoeff(this->pCoeff(p));
...
void Foam::MultiphaseCavitationModels::SchnerrSauer::correct()
{}


bool Foam::MultiphaseCavitationModels::SchnerrSauer::read()
{
