...
Foam::MultiphaseCavitationModels::Kunz::Kunz
(
...
Foam::MultiphaseCavitationModels::Kunz::mDotAlphaW() const
{
...
Foam::Pair<Foam::tmp<Foam::volScalarField>>
Foam::MultiphaseCavitationModels::Kunz::mDotP() const
{
    const volScalarField& p = alpha1_.db().lookupObject<volScalarField>("p");
    volScalarField limitedAlpha1(min(max(alpha1_, scalar(0)), scalar(1)));
...
void Foam::MultiphaseCavitationModels::Kunz::correct()
{}


bool Foam::MultiphaseCavitationModels::Kunz::read()
{
