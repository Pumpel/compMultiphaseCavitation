...
namespace Foam
{
    defineTypeNameAndDebug(multiphaseCavitationMixture, 0);
}


const Foam::scalar Foam::multiphaseCavitationMixture::convertToRad =
    Foam::constant::mathematical::pi/180.0;


// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

void Foam::multiphaseCavitationMixture::calcAlphas()
{
    scalar level = 0.0;
    alphas_ == 0.0;
...
Foam::multiphaseCavitationMixture::multiphaseCavitationMixture
(
...
void Foam::multiphaseCavitationMixture::correct()
{
    forAllIter(PtrDictionary<phaseModel>, phases_, phasei)
    {
        phasei().correct();
...
void Foam::multiphaseCavitationMixture::correctRho(const volScalarField& dp)
{
    ...
    forAllIter(PtrDictionary<phaseModel>, phases_, phasei)
    {
    	forAll(phasei(), celli)
		{
    		// TODO: Test if the value p used here is the new or the old p value.
    			// If it is the old p value, the condition may resolve true, even if it shouldnt
    		if ((p[celli] - dp[celli]) > pMin)
    		{
...
bool Foam::multiphaseCavitationMixture::incompressible() const
{
    bool ico = true;
...
bool Foam::multiphaseCavitationMixture::isochoric() const
{
    bool iso = true;
...
Foam::tmp<Foam::volScalarField> Foam::multiphaseCavitationMixture::he
(
...
Foam::tmp<Foam::scalarField> Foam::multiphaseCavitationMixture::he
(
    const scalarField& p,
    const scalarField& T,
...
Foam::tmp<Foam::volScalarField> Foam::multiphaseCavitationMixture::hc() const
{
    PtrDictionary<phaseModel>::const_iterator phasei = phases_.begin();
...
Foam::tmp<Foam::scalarField> Foam::multiphaseCavitationMixture::THE
(
    const scalarField& h,
    const scalarField& p,
...
Foam::tmp<Foam::volScalarField> Foam::multiphaseCavitationMixture::mixturePsi() const
{
	PtrDictionary<phaseModel>::const_iterator phasei = phases_.begin();
...
Foam::tmp<Foam::volScalarField> Foam::multiphaseCavitationMixture::rho() const
{
    PtrDictionary<phaseModel>::const_iterator phasei = phases_.begin();
...
Foam::tmp<Foam::scalarField> Foam::multiphaseCavitationMixture::rho
(
    const label patchi
) const
{
...
Foam::tmp<Foam::volScalarField> Foam::multiphaseCavitationMixture::Cp() const
{
    PtrDictionary<phaseModel>::const_iterator phasei = phases_.begin();
...
Foam::tmp<Foam::scalarField> Foam::multiphaseCavitationMixture::Cp
(
    const scalarField& p,
    const scalarField& T,
    const label patchi
...
Foam::tmp<Foam::volScalarField> Foam::multiphaseCavitationMixture::Cv() const
{
    PtrDictionary<phaseModel>::const_iterator phasei = phases_.begin();
...
Foam::tmp<Foam::scalarField> Foam::multiphaseCavitationMixture::Cv
(
    const scalarField& p,
    const scalarField& T,
    const label patchi
...
Foam::tmp<Foam::volScalarField> Foam::multiphaseCavitationMixture::gamma() const
{
    PtrDictionary<phaseModel>::const_iterator phasei = phases_.begin();
...
Foam::tmp<Foam::scalarField> Foam::multiphaseCavitationMixture::gamma
(
    const scalarField& p,
    const scalarField& T,
    const label patchi
...
Foam::tmp<Foam::volScalarField> Foam::multiphaseCavitationMixture::Cpv() const
{
    PtrDictionary<phaseModel>::const_iterator phasei = phases_.begin();
...
Foam::tmp<Foam::scalarField> Foam::multiphaseCavitationMixture::Cpv
(
    const scalarField& p,
    const scalarField& T,
    const label patchi
...
Foam::tmp<Foam::volScalarField> Foam::multiphaseCavitationMixture::CpByCpv() const
{
    PtrDictionary<phaseModel>::const_iterator phasei = phases_.begin();
...
Foam::tmp<Foam::scalarField> Foam::multiphaseCavitationMixture::CpByCpv
(
    const scalarField& p,
    const scalarField& T,
    const label patchi
...
Foam::tmp<Foam::volScalarField> Foam::multiphaseCavitationMixture::nu() const
{
    return mu()/rho();
}


Foam::tmp<Foam::scalarField> Foam::multiphaseCavitationMixture::nu
(
    const label patchi
) const
{
...
Foam::tmp<Foam::volScalarField> Foam::multiphaseCavitationMixture::kappa() const
{
    PtrDictionary<phaseModel>::const_iterator phasei = phases_.begin();
...
Foam::tmp<Foam::scalarField> Foam::multiphaseCavitationMixture::kappa
(
    const label patchi
) const
{
...
Foam::tmp<Foam::volScalarField> Foam::multiphaseCavitationMixture::kappaEff
(
...
Foam::tmp<Foam::scalarField> Foam::multiphaseCavitationMixture::kappaEff
(
...
Foam::tmp<Foam::volScalarField> Foam::multiphaseCavitationMixture::alphaEff
(
    const volScalarField& alphat
) const
{
...
Foam::tmp<Foam::scalarField> Foam::multiphaseCavitationMixture::alphaEff
(
    const scalarField& alphat,
    const label patchi
) const
...
Foam::tmp<Foam::volScalarField> Foam::multiphaseCavitationMixture::rCv() const
{
    PtrDictionary<phaseModel>::const_iterator phasei = phases_.begin();
...
Foam::multiphaseCavitationMixture::surfaceTensionForce() const
{
...
void Foam::multiphaseCavitationMixture::solve()
{
...
Foam::tmp<Foam::surfaceVectorField> Foam::multiphaseCavitationMixture::nHatfv
(
...
Foam::tmp<Foam::surfaceScalarField> Foam::multiphaseCavitationMixture::nHatf
(
    const volScalarField& alpha1,
    const volScalarField& alpha2
) const
...
void Foam::multiphaseCavitationMixture::correctContactAngle
(
...
Foam::tmp<Foam::volScalarField> Foam::multiphaseCavitationMixture::K
(
    const phaseModel& alpha1,
    const phaseModel& alpha2
) const
...
Foam::multiphaseCavitationMixture::nearInterface() const
{
...
void Foam::multiphaseCavitationMixture::solveAlphas
(
    const scalar cAlpha
)
{
    ...
    //- /////////////////////////////////////////////////////////////////////////////////////
	//  Before calculating the mass transfer coeffs, set the vapor phase to zero
    //  where the water phase is 100%. This is should reduce the numerical diffusion
    //  without the need to modify the pressure term of the phase equations
	//- /////////////////////////////////////////////////////////////////////////////////////

    // The mass transfer is based on the water phase. Due to errors in the
    // alpha phases occuring at the interfaces, vapor accumulates in regions where
    // the water phase already has the value 1
    // Therefore, the vapor is artificially set to zero where (water >= 1.0 && vapor >= 0.0)

    scalar waterLimit = 0.99999;
    forAllIter(PtrDictionary<phaseModel>, phases_, phasei)
    {
		if (phasei().name() == "vapor")
		{
			phaseModel& alphaV = phasei();
			forAllIter(PtrDictionary<phaseModel>, phases_, phasej)
			{
				if (phasej().name() == "water")
				{
					phaseModel& alphaW = phasej();
					forAll(alphaW, celli)
					{
						if (alphaW[celli] >= waterLimit && alphaV[celli] != 0.0)
						{
							alphaV[celli] = 0.0;
						}
					}
    ...
    forAllIter(PtrDictionary<phaseModel>, phases_, phase)
    {
    	...
    	if (alpha.name() == "water")
    	{
            ...
            forAll(vDotDmPAlphaW, celli)
            {
            	...
            	// Subtracting the potentially missing alpha*div(U) term on the implicit
            	// side of the equation
            	//Sp[celli] -= limitedAlpha[celli]*divU[celli];
            }
    ...
    forAllIter(PtrDictionary<phaseModel>, phases_, phase)
    {
        ...
        // The mass transfer is based on the water phase. Due to errors in the
        // alpha phases, occuring at the interface, vapor accumulates in regions where
        // the water phase already has the value 1
        // Therefore, the vapor is artificially set to zero where (water >= 1.0 && vapor >= 0.0)
        forAllIter(PtrDictionary<phaseModel>, phases_, phasei)
        {
...
//            );
    ...
    // Moved this line to the top, so it can be used for the mass source calcualtion
    //volScalarField divU(fvc::div(fvc::absolute(phi_, U_)));				// Calcs the divergence of the velocity field
    ...
    forAllIter(PtrDictionary<phaseModel>, phases_, phase)
    {
		...
		(
			...
			divU*min(alpha, scalar(1))*0.0 // Setting the term to zero,
			// so that the dimension are still captured. This term is already
			// incorporated by the cavitation model
		);


		// If the phase is neither the liquid nor the vapor phase, the divergence * alpha
		// term must be added explicitly
		if (alpha.name() != "water" || alpha.name() != "vapor")
		{
...

        {
            ...
            forAll(dgdt, celli)
            {
                if (dgdt[celli] < 0.0 && limitedAlpha[celli] > 0.0)
                {
                    ...
                    Su.ref()[celli] -= dgdt[celli]*limitedAlpha[celli];
                }
        ...
        forAllConstIter(PtrDictionary<phaseModel>, phases_, phase2)
        {
            ...
            forAll(dgdt2, celli)
            {
                if (dgdt2[celli] > 0.0 && limitedAlpha2[celli] < 1.0)
                {
                    ...
                    Su.ref()[celli] += dgdt2[celli]*alpha[celli];
                }
    ...
    // The sum of all alpha values minus one, giving the phase error
    alphaSum_ *= 0.0;
    forAllIter(PtrDictionary<phaseModel>, phases_, phasei)
    {
    	alphaSum_ += phasei();
    ...
    // Check if this can be omitted to speed up the calculation
    forAllIter(PtrDictionary<phaseModel>, phases_, phase)
    {
    	forAll(phase(), celli)
		{
